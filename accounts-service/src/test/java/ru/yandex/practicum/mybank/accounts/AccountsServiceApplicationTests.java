...
class AccountsServiceApplicationTests {
    private static final Logger TEST_LOGGER = (Logger) LoggerFactory.getLogger(AccountsServiceApplicationTests.class);
    ...
    void traceIdsAreAddedToMdc() {
        ...
        var span = tracer.nextSpan().name("accounts-mdc-test").start();
        try (Tracer.SpanInScope ignored = tracer.withSpan(span)) {
            TEST_LOGGER.info("accounts mdc test");
        } finally {
            span.end();
