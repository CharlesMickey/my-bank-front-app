...
class CashServiceApplicationTests {
    private static final Logger TEST_LOGGER = (Logger) LoggerFactory.getLogger(CashServiceApplicationTests.class);
    ...
    void traceIdsAreAddedToMdc() {
        ...
        var span = tracer.nextSpan().name("cash-mdc-test").start();
        try (Tracer.SpanInScope ignored = tracer.withSpan(span)) {
            TEST_LOGGER.info("cash mdc test");
        } finally {
            span.end();
